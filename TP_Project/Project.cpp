...
int main(int argc, char** argv) {
    ...
    Object support;
    support.modelMatrix = glm::mat4(1.0f);
    support.position = glm::vec3(4.5f, 0.7f, -10.2f);
    support.scale = glm::vec3(5.8f,0.5f,1.0f);
    support.rotationAxis = glm::vec3(0.0f, 0.0f, 1.0f);
    support.rotationAngle = 0.0f;
    support.kd = glm::vec3(0.5f, 0.5f, 0.5f);
    support.ks = glm::vec3(1.0f, 1.0f, 1.0f);
    support.color = rouge;
    support.shininess = 64.0f;
    support.vao = quadVAO;
    support.vertexCount = quadrilateral.getVertexCount();
    support.updateModelMatrix();
    objects.push_back(support);

    Object coulisseau;
    coulisseau.modelMatrix = glm::mat4(1.0f);
    coulisseau.position = glm::vec3(9.4f, 0.6f, -9.99f);
    coulisseau.scale = glm::vec3(0.5f,0.5f,0.3f);
    coulisseau.rotationAxis = glm::vec3(0.0f, 0.0f, 1.0f);
    coulisseau.rotationAngle = 0.0f;
    coulisseau.kd = glm::vec3(0.5f, 0.5f, 0.5f);
    coulisseau.ks = glm::vec3(1.0f, 1.0f, 1.0f);
    coulisseau.color = jaune;
    coulisseau.shininess = 64.0f;
    coulisseau.vao = quadVAO;
    coulisseau.vertexCount = quadrilateral.getVertexCount();
    coulisseau.updateModelMatrix();
    objects.push_back(coulisseau);
